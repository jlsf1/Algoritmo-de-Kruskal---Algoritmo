...
Em posse desses dados, criamos um programa que cria um grafo de modo que os vértices se relacionariam entre si, a partir do desejo da criação de um roteiro de interesses, as arestas teriam como peso as distâncias entre os locais turísticos.
